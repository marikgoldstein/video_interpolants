...
class VQVAE(nn.Module):
    def __init__(self, args, ckpt_path=None):
        ...
        self.encoder = Encoder(
            ...
            out_channels = args.vqvae_river_encoder_out_channels,
        )
        self.decoder = Decoder(
            in_channels = args.vqvae_river_decoder_in_channels,
            out_channels = args.vqvae_river_decoder_out_channels,
        )
        self.vector_quantizer = VectorQuantizer(
            ne = args.vqvae_river_vector_quantizer_num_embeddings,
            e_dim = args.vqvae_river_vector_quantizer_embedding_dimension,
            beta = 0.25
        )
